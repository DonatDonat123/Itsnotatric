...
function FullScreenBackground(theItem){
    ...
    $(theItem).css("margin-left",(0)).css("margin-top",((winHeight-$(theItem).outerHeight())/2));
...
var images=["ajax-loader_dark.gif","./static/fotos/round_custom_scrollbar_bg_over.png"];
