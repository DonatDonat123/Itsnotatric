	...
	function CustomScroller(){
		...
		if($customScrollBox_container.height()>visibleHeight){ //custom scroll depends on content height
			...
			function DraggerOver(){
				$dragger.css("background", "url(./static/fotos/round_custom_scrollbar_bg_over.png)");
			}

			function DraggerOut(){
				$dragger.css("background", "url(./static/fotos/round_custom_scrollbar_bg.png)");
			}
...
var images=["./static/fotos/ajax-loader_dark.gif","./static/fotos/round_custom_scrollbar_bg_over.png"];
